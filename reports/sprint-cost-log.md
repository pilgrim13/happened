...
| 2026-04-26 | Sprint 4 (tokens 확장 + ScreenState) | ~4min | ~30 | 0.026K | 12K | 1.46M | **$0.849** | ✅ |
| 2026-04-26 | Sprint 5A (Recall 모델 + 푸시 토큰 + 딥링크 정책) | ~9min | ~50 | 0.057K | 29K | 3.51M | **$1.935** | ✅ |
| 2026-04-26 | Sprint 5B (Recall UI + 푸시 훅 + Apple SignIn + 딥링크) | ~10min | 63 | 0.100K | 29K | 4.50M | **$2.290** | ✅ |
| | **누적 합계** | | | | | | **$7.242** | |
