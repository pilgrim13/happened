...
const translations = {
  en: {
    ...
    'auth.loginCopy': 'The last email is kept. Default test account: test@happened.dev / happened-test-1.',
    'auth.email': 'Email',
    'auth.name': 'Name',
    'auth.nickname': 'Nickname',
    'auth.password': 'Password',
    'auth.working': 'Working...',
    'auth.quick': 'Quick test account',
  ...
  ko: {
    ...
    'auth.loginCopy': '마지막 이메일은 유지됩니다. 기본 테스트 계정은 test@happened.dev / happened-test-1 입니다.',
    'auth.email': '이메일',
    'auth.name': '이름',
    'auth.nickname': '닉네임',
    'auth.password': '비밀번호',
    'auth.working': '처리 중...',
    'auth.quick': '빠른 테스트 계정',
